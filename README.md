...
Here's a rough guide to the process used to create the site this year. No promises this will work perfectly on your first try given the experience of navigating updates to Hugo and Netlify. Hopefully this will make the process much smoother.

In terms of timing, the 2025 rebuild took a single 8-hour workday. In 2024 there were more extensive changes (i.e., migrating the website to a new design template) that took closer to four 8-hour workdays. If you're more experienced at building and deploying websites via GitHub, you can probably make quick work of this. If you're new to it, it would be preferable to allot yourself more time.

1.	Create new repository from previous site:
a.	Go to https://github.com/dgraetz/summeRbootcamp2026
b.	Select Code > Download Zip
c.	Unzip folder and rename it to summeRbootcamp2027
2.	Make that folder a new repo in GitHub Desktop
a.	Open GitHub Desktop
b.	Go to File -> Add local repository....
c.	Select the unzipped summeRbootcamp2027 folder.
d.	GitHub Desktop will say "This does not appear to be a Git repository." -> click Create a repository here.
i.	Give it the name you want (summeRbootcamp2027).
...
a.	From your finder, locate Users/GitHub/summeRbootcamp2027
b.	Open the .Rproj file (***Always start by opening this file***)
...
8.	Edit site name and URL
a.	config/_default/hugo.yaml -- update BOTH `title` and `baseURL`
9.	Edit Slides
